...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFBBdQgORAE+1EbsQ5+n//NamskUPW+Y2bIqb7qOLIesa5EKkQIIk2nNOgYUJFB44
::YB416Ek+ZG8=
::
::
...
echo                                ░  ░          ░  ░  ░   ░         ░ ░     ░     ░              ░  ░
echo                                                                        ░                                                                                                                               
echo                                                  %c%Created By: sjay4087%t%     
echo                 DISCLAIMER: IF APHRODITE SERVICES DID NOT SELL YOU THIS DIRECTLY YOU HAVE BEEN SCAMMED!!                  
echo.
echo %w%════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%y%
echo.
echo.
echo.
echo                                     %w%[%y% %c%%u%1%q%%t% %w%]%y% Press 1 And Hit Enter To Apply Zero Delay   
echo. 
echo.
echo.                                                    
echo.
...
:: Clearing Input Delay
echo Clearing Input Delay (Dont Close)
REM ; Zero Startup Delay
